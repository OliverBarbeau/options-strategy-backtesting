...
3. **~14-day DTE is the sweet spot.** It balances premium against risk exposure.
...
See **[FINDINGS.md](FINDINGS.md)** for a plain-language write-up of the methodology, a directional results table, and these findings in more depth.
